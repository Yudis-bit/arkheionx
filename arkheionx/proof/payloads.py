...
def build_proof_payload(
    ...
    *,
    review_map_target: str = "",
    related_test_gap: str = "",
    proof_suggestion_id: str = "",
) -> dict:
    trace = result.trace or {}
    review_target = review_map_target or target_display
    return {
        "schema_version": PROOF_SCHEMA_VERSION,
        "arkheionx_version": __version__,
        "package_version": PACKAGE_VERSION,
        "proof_receipt_id": f"proof:{target_slug(review_target)}",
        "target": target_display,
        "target_id": target_id,
        "review_map_target": review_target,
        "related_test_gap": related_test_gap,
        "proof_suggestion_id": proof_suggestion_id,
...
def build_trace_payload(
    ...
    *,
    ...
    return {
        ...
        "trace_receipt_id": f"trace:{target_slug(review_target)}",
        "target": target_display,
        "target_id": target_id or target_display,
        "review_map_target": review_target,
