...
DEMOS: list[Demo] = [
    Demo(
        ...
        description="Local fixture for the staking/reward/oracle workflow.",
        ...
        category="staking",
        risk_theme="oracle/rewards",
    ),
    Demo(
        id="amm-swap",
        name="AMM Swap Fixture",
        description="Local fixture for the swap/reserve/liquidity workflow.",
        path="arkheionx/demo/fixtures/amm-swap",
        recommended_target="AMMSwapFixture.swapAForB",
        requires_foundry=False,
        expected_mode="heuristic (compiler/execution-confirmed with Foundry)",
        docs="docs/DEMO_WORKFLOW.md",
        notes="Toy fixture only. Not a production AMM and not a real vulnerability report.",
        category="amm",
        risk_theme="swap/reserves",
    ),
    Demo(
        id="lending-vault",
        name="Lending Vault Fixture",
        description="Local fixture for the collateral/debt/liquidation workflow.",
        path="arkheionx/demo/fixtures/lending-vault",
        recommended_target="LendingVaultFixture.borrow",
        requires_foundry=False,
        expected_mode="heuristic (compiler/execution-confirmed with Foundry)",
        docs="docs/DEMO_WORKFLOW.md",
        notes="Toy fixture only. Not a real lending market and not a real vulnerability report.",
        category="lending",
        risk_theme="collateral/debt",
    ),
]
