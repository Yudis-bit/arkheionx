...
# Package version is 8.0.1 (the v8.0.1 "Clean Product Surface" release). v8.0.1 is a
...
# installers and the GitHub Action pin to. The v8.0.1 git tag, GitHub Release, and
# site deploy are founder actions performed at release time.
__version__ = "8.0.1"
PACKAGE_VERSION = "8.0.1"
STABLE_RELEASE = "v8.0.1"
CURRENT_MILESTONE = "v8.0.1"
