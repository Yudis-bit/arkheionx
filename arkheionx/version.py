...
# release). The v5.0.0 git tag, GitHub Release, and site deploy are founder
# actions; until that tag is cut, the last published tag remains v4.0.0, and the
# last actually-tagged stable release the source installers and the GitHub Action
# pin to remains v3.1.0.
__version__ = "5.0.0"
