#!/bin/sh
# Arkheionx local installer (v2.6.0 — arkup & install lifecycle).
#
...
#   ARKHEIONX_STABLE_TAG     Stable tag for the stable channel (default: v2.5.0)
...
ARKHEIONX_STABLE_TAG="${ARKHEIONX_STABLE_TAG:-v2.5.0}"
