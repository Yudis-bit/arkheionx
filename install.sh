#!/bin/sh
# Arkheionx local installer (v3.0.0 — arkup & install lifecycle).
#
...
#   ARKHEIONX_STABLE_TAG     Stable tag for the stable channel (default: v3.0.0)
...
ARKHEIONX_STABLE_TAG="${ARKHEIONX_STABLE_TAG:-v3.0.0}"
