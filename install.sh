#!/bin/sh
# Arkheionx local installer (v3.1.0 — arkup & install lifecycle).
#
...
#   ARKHEIONX_STABLE_TAG     Stable tag for the stable channel (default: v6.0.0)
...
ARKHEIONX_STABLE_TAG="${ARKHEIONX_STABLE_TAG:-v6.0.0}"
