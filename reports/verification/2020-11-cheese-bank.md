...
- **Title:** Pickle Finance — swapExactJarForJar arbitrary-call cDAI strategy asset loss
...
pDAI strategy cDAI position redirected to attacker (tx.origin); historical incident reported around $19.7M for the broader Pickle Finance cDAI exploit.
...
- **Code-observed label:** Pickle Finance — `swapExactJarForJar` arbitrary-call cDAI strategy asset loss (`unsafe-external-call`, fork block 11303122)
