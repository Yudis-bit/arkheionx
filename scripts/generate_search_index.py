...
STATIC_INDEX = [
    ...
    ("Pre-v2 CLI candidate", "docs/archive/legacy-workflows/CLI_CANDIDATE.md", ["CLI candidate", "module CLI", "pre-v2 CLI"]),
    ("CLI commands", "docs/archive/legacy-workflows/CLI_COMMANDS.md", ["arkheionx scan", "validate-config", "test-plan"]),
    ("CLI migration to v2", "docs/archive/legacy-workflows/CLI_MIGRATION_TO_V2.md", ["CLI migration to v2", "command surface", "installable CLI"]),
    ("Installation", "docs/INSTALLATION.md", ["installable CLI", "editable install", "arkheionx command"]),
    ("CLI installable guide", "docs/archive/legacy-workflows/CLI_INSTALLABLE.md", ["console entrypoint", "local package install", "v2 CLI"]),
    ...
    ("CLI roadmap", "docs/archive/legacy-workflows/CLI_ROADMAP.md", ["CLI roadmap", "installable CLI", "v2 package path"]),
