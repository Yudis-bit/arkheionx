...
- Generated at: `2026-05-27T11:05:35+00:00`
- Protocol type: `amm`
...
- Generated issue plan: `examples/reports/package-cli-amm-issue-plan.json`
- Issue plan JSON can be used with `scripts/create_github_issues.py` in dry-run, create, or update mode.

## GitHub Action Outputs

- Markdown Report: `examples/reports/package-cli-amm-report.md`
- Json Report: `examples/reports/package-cli-amm-report.json`
- Sarif Report: `examples/reports/package-cli-amm.sarif.json`
- Issue Plan: `examples/reports/package-cli-amm-issue-plan.json`
