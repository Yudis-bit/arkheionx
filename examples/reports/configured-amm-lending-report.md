...
- Config source: `examples/configs/amm-lending.config.json`
- Effective protocol type: `hybrid`
- Enabled rule packs: `access-control, amm, docs, lending, oracle, reentrancy-value-flow, testing`
...
Search tags: `invariant-testing, hybrid`
...
- Markdown Report: `examples/reports/configured-amm-lending-report.md`
- Json Report: `examples/reports/configured-amm-lending-report.json`
- Sarif Report: `examples/reports/configured-amm-lending.sarif.json`
