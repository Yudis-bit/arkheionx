...
- [ ] ARK-RWD-002 - Add precision, dust, rounding, and small-balance tests for accumulator or index logic.
  ...
  - Suggested labels: `arkheionx, medium-readiness-gap, pre-audit-readiness, precision, reward-accounting, staking-rule-pack`
  - Suggested tests:
...
- [ ] ARK-RWD-003 - Add tests proving users cannot claim the same reward entitlement twice.
  ...
  - Suggested labels: `arkheionx, claim-flow, medium-readiness-gap, pre-audit-readiness, reward-accounting, staking-rule-pack`
  - Suggested tests:
...
```sh
python3 scripts/create_github_issues.py --issue-plan examples/reports/oracle-staking-fixture-issue-plan.json --mode dry-run
```

Create issues:

```sh
python3 scripts/create_github_issues.py --issue-plan examples/reports/oracle-staking-fixture-issue-plan.json --mode create --max-issues 5
```
