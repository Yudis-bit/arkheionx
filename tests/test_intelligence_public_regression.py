...
class MetadataUnchangedTests(unittest.TestCase):
    def test_version_metadata_is_frozen(self) -> None:
        self.assertEqual(version.PACKAGE_VERSION, "6.0.0")
        self.assertEqual(version.STABLE_RELEASE, "v6.0.0")
        self.assertEqual(version.CURRENT_MILESTONE, "v6.0.0")
        self.assertEqual(version.NEXT_MILESTONE, "v6.1.0")
