...
class MetadataUnchangedTests(unittest.TestCase):
    def test_version_metadata_is_frozen(self) -> None:
        self.assertEqual(version.PACKAGE_VERSION, "4.0.0")
        self.assertEqual(version.STABLE_RELEASE, "v3.1.0")
        self.assertEqual(version.CURRENT_MILESTONE, "v4.0.0")
        self.assertEqual(version.NEXT_MILESTONE, "v4.1.0")
