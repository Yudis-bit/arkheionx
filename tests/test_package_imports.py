...
class PackageImportTests(unittest.TestCase):
    def test_package_imports_and_version_metadata(self) -> None:
        ...
        self.assertEqual(arkheionx.__version__, "2.0.1-dev")
        self.assertEqual(__version__, "2.0.1-dev")
        self.assertEqual(STABLE_RELEASE, "v2.0.0")
        self.assertEqual(CURRENT_MILESTONE, "v2.0.1")
        self.assertEqual(NEXT_MILESTONE, "v2.1.0")
