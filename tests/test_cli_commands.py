...
class CliCommandTests(unittest.TestCase):
    ...
    def test_help_version_and_doctor_exit_zero(self) -> None:
        ...
        self.assertIn("2.2.0", version.stdout)
        self.assertNotIn("2.2.0-dev", version.stdout)
        self.assertIn("Latest stable release: v2.2.0", version.stdout)
        self.assertIn("v2.2.0", version.stdout)
        self.assertIn("v2.3.0", version.stdout)
