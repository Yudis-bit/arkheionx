...
class CliCommandTests(unittest.TestCase):
    ...
    def test_help_version_and_doctor_exit_zero(self) -> None:
        ...
        self.assertIn("package version: 6.0.0", version.stdout)
        self.assertIn("Latest stable release: v6.0.0", version.stdout)
        self.assertIn("Current milestone: v6.0.0", version.stdout)
        self.assertIn("Next milestone: v6.1.0", version.stdout)
    ...
    def test_version_includes_package_version_and_next_step(self) -> None:
        ...
        self.assertEqual(result.returncode, 0, result.stdout + result.stderr)
        self.assertIn("package version: 6.0.0", result.stdout)
