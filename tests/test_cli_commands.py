...
class CliCommandTests(unittest.TestCase):
    ...
    def test_help_version_and_doctor_exit_zero(self) -> None:
        ...
        self.assertIn("package version: 9.1.0.dev0", version.stdout)
        self.assertIn("Latest stable release: v8.0.1", version.stdout)
        self.assertIn("Current milestone: v9.1.0-dev", version.stdout)
        self.assertIn("Next milestone: v9.1.0", version.stdout)
