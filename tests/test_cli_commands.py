...
class CliCommandTests(unittest.TestCase):
    ...
    def test_help_version_and_doctor_exit_zero(self) -> None:
        ...
        self.assertIn("package version: 2.5.0", version.stdout)
        self.assertNotIn("2.5.0-dev", version.stdout)
        self.assertIn("Latest stable release: v2.5.0", version.stdout)
        self.assertIn("Current milestone: v2.5.0", version.stdout)
        self.assertIn("Next milestone: v2.6.0", version.stdout)
