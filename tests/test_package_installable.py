...
class PackageInstallableTests(unittest.TestCase):
    def test_pyproject_declares_console_entrypoint(self) -> None:
        ...
        self.assertEqual(data["project"]["version"], "6.0.0")
    ...
    def test_editable_install_and_console_version(self) -> None:
        ...
        self.assertIn("Latest stable release: v6.0.0", result.stdout)
        self.assertIn("Current milestone: v6.0.0", result.stdout)
        self.assertIn("Next milestone: v6.1.0", result.stdout)
