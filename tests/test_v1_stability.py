...
STABLE_ACTION = "Yudis-bit/DeFi-Exploit-PoCs/.github/actions/pre-audit@v1.5.0"
...
class V1StabilityTests(unittest.TestCase):
    ...
    def test_public_docs_name_v1_stable_surface(self) -> None:
        ...
        self.assertIn("Stable v1.5.x Surface", readme)
        ...
        self.assertIn("Stable v1.5.x Inputs", action_docs)
    ...
    def test_changelog_and_roadmap_mark_v1_candidate(self) -> None:
        ...
        self.assertIn("## v1.6.0 - Unreleased", changelog)
        self.assertIn("## v1.5.0", changelog)
        self.assertNotIn("## v1.5.0 - Unreleased", changelog)
        ...
        self.assertIn("v1.6.0: Internal Engine Split current milestone", roadmap)
        self.assertIn("v1.7.0: Config + Rule Pack Stabilization", roadmap)
