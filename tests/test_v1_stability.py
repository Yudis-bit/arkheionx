...
class V1StabilityTests(unittest.TestCase):
    ...
    def test_public_docs_name_v1_stable_surface(self) -> None:
        ...
        self.assertIn("Stable v1.2.x Surface", readme)
        ...
        self.assertIn("Stable v1.2.x Inputs", action_docs)
    ...
    def test_changelog_and_roadmap_mark_v1_candidate(self) -> None:
        ...
        self.assertIn("## v1.3.0 - Unreleased", changelog)
        ...
        self.assertIn("v1.3.0: Ecosystem Pack current milestone", roadmap)
        self.assertIn("v1.4.0: AMM + Lending Protocol Packs", roadmap)
