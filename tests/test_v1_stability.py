...
STABLE_ACTION = "Yudis-bit/DeFi-Exploit-PoCs/.github/actions/pre-audit@v1.6.0"
...
class V1StabilityTests(unittest.TestCase):
    ...
    def test_public_docs_name_v1_stable_surface(self) -> None:
        ...
        self.assertIn("Stable v1.6.x Surface", readme)
        ...
        self.assertIn("Stable v1.6.x Inputs", action_docs)
    ...
    def test_changelog_and_roadmap_mark_v1_candidate(self) -> None:
        ...
        self.assertIn("## v1.7.0 - Unreleased", changelog)
        self.assertIn("## v1.6.0", changelog)
        self.assertNotIn("## v1.6.0 - Unreleased", changelog)
        ...
        self.assertIn("v1.7.0: Config + Rule Pack Stabilization current milestone", roadmap)
        self.assertIn("v1.8.0: Report UX + Noise Reduction", roadmap)
