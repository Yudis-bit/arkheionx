...
## 13. v3.1.0 — Protocol Review Map (shipped)
**v3.1.0 — Protocol Review Map** shipped as the current latest stable release.
...
latest stable release is now **v3.1.0**; the next active milestone is **v3.2.0**.
See [`REVIEW_MAP.md`](REVIEW_MAP.md).
