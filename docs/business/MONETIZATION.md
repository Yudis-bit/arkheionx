...
The demo artifact bundle helps users inspect Launch Report, Sprint Plan,
Contest Readiness, issue-plan, and remediation-roadmap structure before any
paid conversation.
...
Preview path: run the five-minute demo and inspect `demo-launch-report.md`,
`demo-executive-summary.md`, and `demo-remediation-roadmap.md`.
...
Preview path: inspect `demo-sprint-plan.md` and the oracle/staking
before/after toy case study.
