...
## v0.8.0 Public Demo Message

Primary v0.8.0 message:

> Arkheionx v0.8.0 makes the project easier to evaluate: a five-minute demo
> workflow, toy case studies, before/after readiness examples, rule calibration
> notes, and external feedback templates.

Builder angle:

> Before scanning your own repository, run the demo and inspect the exact
> artifact bundle: report, JSON, SARIF, issue plan, Launch Report, Sprint Plan,
> Contest Readiness report, executive summary, and remediation roadmap.
...
14. Arkheionx v0.8.0 adds the public evaluation layer: try it in five minutes,
    inspect demo reports, compare before/after toy fixtures, and report noisy
    findings through calibration templates.
