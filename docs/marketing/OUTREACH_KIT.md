...
## v0.8 Demo Link Message

```text
If you want to evaluate Arkheionx without trying it on your own repo yet, start
with the five-minute demo. It uses toy fixtures only and generates the full
artifact bundle: readiness report, SARIF, issue plan, Launch Report, Sprint
Plan, Contest Readiness report, executive summary, and remediation roadmap.

No live-chain calls, no RPC, no secrets, no audit claims.
```
...
Use [`docs/business/PROPOSAL_TEMPLATE.md`](../business/PROPOSAL_TEMPLATE.md) for paid work.
